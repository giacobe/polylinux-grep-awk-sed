...
for cmd in adduser awk base64 cat chmod chown cp cut date find grep head id ln mkdir mv passwd printf rm sed sha256sum sleep sort su tail tr uniq wc xxd; do command_required "$cmd"; done
